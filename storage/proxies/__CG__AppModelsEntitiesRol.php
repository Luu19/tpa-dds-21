 ...
 */
class Rol extends \App\Models\Entities\Rol implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Models\\Entities\\Rol' . "\0" . 'id', '' . "\0" . 'App\\Models\\Entities\\Rol' . "\0" . 'descripcion', '' . "\0" . 'App\\Models\\Entities\\Rol' . "\0" . 'tipo', '' . "\0" . 'App\\Models\\Entities\\Rol' . "\0" . 'permisos'];
        }
